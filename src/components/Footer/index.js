        ...
        <div className={styles.content}>
          <div className={styles.item}>
            ...
            <p className={styles.item_content}>
              Hệ thống bán lẻ đồ thể thao TDesign Sport là đơn vị chuyên sản xuất và phân phối các
              sản phẩm thể thao chuyên nghiệp. Tại đây bạn có thể dễ dàng mua Quần áo và dụng cụ thể
              thao chất lượng cao, chính hãng... Địa chỉ: 204 Trần Duy Hưng, quận Cầu Giấy, TP Hà
              Nội
            </p>
          ...
          <div className={styles.item}>
            ...
            <p className={styles.item_content}>
              Hãy nhập email của bạn để chúng tôi gửi email ngay khi có thông tin về những chương
